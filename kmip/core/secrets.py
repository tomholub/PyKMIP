...
class SplitKey(primitives.Struct):
    ...
    def __repr__(self):
        args = [
            ...
            "split_key_method={}".format(repr(self.split_key_method)),
    ...
    def __str__(self):
        ...
        return json.dumps(
            {
                "split_key_parts": self.split_key_parts,
                "key_part_identifier": self.key_part_identifier,
                "split_key_threshold": self.split_key_threshold,
                "split_key_method": self.split_key_method,
                "prime_field_size": self.prime_field_size,
                "key_block": str(self.key_block)
            }
        )
